        ...
        <form data-cy="formulario-contacto" class="formulario" action="/contacto" method="POST">
            ...
            <fieldset>
                ...
                <div class="forma-contacto">
                    ...
                    <input data-cy="forma-contacto" type="radio" value="telefono" id="contactar-telefono" name="contacto[contacto]" > <!--el name tiene que ser el mismo porque es un 
                    input radius, pero lo que define que es lo que se va a enviar al formulario es el value-->
